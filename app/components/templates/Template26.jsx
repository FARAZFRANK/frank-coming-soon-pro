      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "1rem", maxWidth: "600px" }}>
        ...
        <div className="t26-top-section" style={{ marginBottom: "1.5rem" }}>
          {logoUrl && logoUrl !== "null" ? (
            <img src={logoUrl} alt="Logo" style={{ height: "35px", width: "auto", objectFit: "contain", margin: "0 auto 1.2rem" }} />
          ) : (
            <SpoonForkIcon />
          )}
          ...
          <p style={{ fontSize: "1.1rem", fontWeight: 300, color: "#F3EFE0", letterSpacing: "0.1em", marginTop: "0.5rem" }}>
        ...
        <div style={{ maxWidth: "400px", margin: "0 auto" }}>
          <p style={{ marginBottom: "1rem", fontSize: "1rem", color: "#F3EFE0" }}>Be the first to get opening day reservations.</p>
